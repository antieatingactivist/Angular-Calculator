...
export class KeypadComponent implements OnInit {
  ...
  keyAttributes: Array<IKey> = [
    ...
    {label: "<span class='sup'>+</span>⁄<span class='sub'>-</span>", color: this.colors[0], width: 65, type: "changeSign", action: () => this.changeSign()}, 
    ...
    {label: "✕", color: this.colors[1], width: 65, type: "multiply", active: false, action: () => this.changeActivation("multiply")}, 
